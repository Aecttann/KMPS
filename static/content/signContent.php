<div class="ex-form ui-helper-clearfix ui-corner-all">
	...
	<form action="testsign.php" method="POST">
		...
		<h2 style="text-transform: none;"><?php echo $Lang["signForm"]; ?></h2>
			<fieldset class="ui-corner-all" style="height:55px;">
				<label>
	...
	-->
	<div align="center"><input class="button" type="submit" name="submit" value="<?php echo $Lang["signButton"]; ?>"></input></div>
	</form>
</div>
